...
exports.run = async function(client, message, args) {
  ...
  var specibus = client.playerMap.get(charid,"spec");
...
let plonline = client.traitcall.compTest(client,message,charid,room,currentInv,specibus);
if(plonline[0]){
...
targonline = client.traitcall.compTest(client,message,chumroll[i],targroom,targcurrentInv,specibus);
  if(targonline[0]){
